...
func (c *articleClient) IncreaseBuyCount(ctx context.Context, in *GetByIDReq, opts ...grpc.CallOption) (*BuyCount, error) {
	out := new(BuyCount)
...
func _Article_IncreaseBuyCount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ArticleServer).IncreaseBuyCount(ctx, req.(*GetByIDReq))
	}
	return interceptor(ctx, in, info, handler)
}
